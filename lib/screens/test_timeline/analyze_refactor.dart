...
class AnalyzeRefactor extends StatelessWidget {
  List<String> listCheck = List();

  final TimeLineViewModel timelineModel;

  final String transactionId;
  AnalyzeRefactor({@required this.timelineModel, @required this.transactionId});
                ...
                children: [
                  ...
                  Visibility(
                    ...
                    child: Positioned(
                        bottom: 10,
                        child: Container(
                          width: MediaQuery.of(contextB).size.width * 0.6,
                          child: Padding(
